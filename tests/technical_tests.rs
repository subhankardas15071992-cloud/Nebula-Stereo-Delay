...
fn randomized_fuzz_test() {
    ...
    for iter in 0..iterations {
        ...
        let params = DelayParams {
            ...
            wet_level_l: prng.next_range(0.0, 1.0),
            wet_level_r: prng.next_range(0.0, 1.0),
            dry_level_l: prng.next_range(0.0, 1.0),
            dry_level_r: prng.next_range(0.0, 1.0),
            wet_pan_l: prng.next_range(0.0, 1.0),
            wet_pan_r: prng.next_range(0.0, 1.0),
            dry_pan_l: prng.next_range(0.0, 1.0),
            dry_pan_r: prng.next_range(0.0, 1.0),
